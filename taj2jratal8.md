...
comment_text = ''                                #this is optional. if left out, the header text will be marked as a comment using adata = array([angle, V_pd, V_pd_delta]).T        #create a 2D matrix and transpose rows and columns 
