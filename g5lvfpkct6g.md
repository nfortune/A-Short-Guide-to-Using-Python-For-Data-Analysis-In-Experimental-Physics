...
from numpy import *
from uncertainties import ufloat, unumpy  # these are the equivalent of floating point numbers and arrays
...
theta_array = unumpy.uarray(theta_data, delta_theta) # create an array of angle values with uncertainty
```