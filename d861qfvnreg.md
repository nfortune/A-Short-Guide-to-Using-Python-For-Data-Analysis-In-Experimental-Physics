...
x = cos(angle_in_radians)                 # calculate cosine for each element in array, assign values to an array  'x'
y = sin(angle_in_radians)                 # calculate sine for each element in array
