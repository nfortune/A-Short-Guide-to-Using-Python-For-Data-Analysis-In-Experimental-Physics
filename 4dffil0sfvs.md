...
data_derivative = savgol_filter(noisy_data, window_width, polynomial_order, deriv = 1, delta = 0.1) #take 1st derivative, assuming x spacing between  delta_x = 0.1 between data points y(x_i)  
