...
#filefolder = 'data/'                             # use this if data file is in a _subfolder called data ('relative' address)
#filefolder = '/Users/nfortune/Python_Workspace'  # use this if data file is in a folder called 
