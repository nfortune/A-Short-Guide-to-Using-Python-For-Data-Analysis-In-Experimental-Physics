...
#filefolder = '/Users/nfortune/Python_Workspace'  # use this if data file is in a folder called Python_Workspace  found inside the folder nfortune within the Users directory (such as with )
